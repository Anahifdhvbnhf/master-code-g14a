/*
Crear una aplicacion que nos permita a un profesor generar las notas definitivas de sus alumnos.

Debemos permitit al profesor que nos indique cuantos alumnos va a calificar.
Debemos permitir al profesor ingresar la cantidad de notas que va a promediar en general.
Con esa notas vamos a obtener el promedio de cada estudiante.
...
cantidadNotas = Number(prompt('Ingresa la cantidad de notas ha promediar de los alumnos'));
...
for (i=1; i<= cantidadAlumnos; i++){
    ...
    alumno = "Alumno:" + nombre + "- Calificaciones:" + Math.round(promedio,2);
